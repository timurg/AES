        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LastActivityDateTime = table.Column<DateTimeOffset>(type: "TEXT", nullable: true),
                    WhenSetPassWord = table.Column<DateTimeOffset>(type: "TEXT", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AgreementDate = table.Column<DateTimeOffset>(type: "TEXT", nullable: false),
                    ActiveAgreement = table.Column<bool>(type: "INTEGER", nullable: false),
                    Semester = table.Column<byte>(type: "INTEGER", nullable: false),
                    WhenSemesterBegin = table.Column<DateTimeOffset>(type: "TEXT", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StoryGeneration = table.Column<uint>(type: "INTEGER", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "TEXT", nullable: false),
                    DateOfAppointment = table.Column<DateTimeOffset>(type: "TEXT", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DateViewed = table.Column<DateTimeOffset>(type: "TEXT", nullable: true),
                    ItemIndex = table.Column<int>(type: "INTEGER", nullable: false),
                    ...
                    IsPassed = table.Column<bool>(type: "INTEGER", nullable: true),
                    ...
                    SelectedItem = table.Column<uint>(type: "INTEGER", nullable: true),
                    Longitude = table.Column<float>(type: "REAL", nullable: true),
                    Latitude = table.Column<float>(type: "REAL", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "TEXT", nullable: false),
                    GradeDateTime = table.Column<DateTimeOffset>(type: "TEXT", nullable: false),
                    IsPassed = table.Column<bool>(type: "INTEGER", nullable: false),
                    GradeRecordType = table.Column<int>(type: "INTEGER", nullable: false),
                    ModuleItemId = table.Column<Guid>(type: "TEXT", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TypeTestingId = table.Column<Guid>(type: "TEXT", nullable: false),
                    Semester = table.Column<int>(type: "INTEGER", nullable: false),
                    LearningProcessId = table.Column<Guid>(type: "TEXT", nullable: true),
                    LearningProcessesType = table.Column<int>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
                {
